...
<div class="card">
  ...
  <div class="mb-3" >
    ...
    <input type="text" class="form-control" id="Userial" name="Userial" value="<?php echo $activo['Userial']; ?>">
  </div>

  <div class="mb-3">
    <label for="Uplaca" class="form-label">Placa</label>
    <input type="text" class="form-control" id="Uplaca" name="Uplaca" value="">
  </div>

  <div class="mb-3">
    <label for="Udescripcion1" class="form-label">Descripcion de elemento</label>
    <input type="text" class="form-control" id="Udescripcion1" name="Udescripcion1" value="">
  </div>

  <div class="mb-3">
    <label for="Umarca" class="form-label">Marca</label>
    <input type="text" class="form-control" id="Umarca" name="Umarca" value="">
  </div>

  <div class="mb-3">
    <label for="Umodelo" class="form-label">Modelo</label>
    <input type="text" class="form-control" id="Umodelo" name="Umodelo" value="">
  </div>

  <div class="mb-3">
    <label for="Udescripcion2" class="form-label">Descripcion Adicional</label>
    <input type="text" class="form-control" id="Udescripcion2" name="Udescripcion2" value="">
  </div>
