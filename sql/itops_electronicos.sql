...
CREATE TABLE `electronicos` (
  `idelectronicos` int(11) NOT NULL,
  `nombre` varchar(45) DEFAULT NULL,
  `total` int(11) DEFAULT NULL,
  PRIMARY KEY (`idelectronicos`)
...
INSERT INTO `electronicos` VALUES (1,'teclados',20),(2,'mouse',40),(3,'monitores',40),(4,'portatiles',20);
...
-- Dump completed on 2024-01-10 16:32:08
